...
function checkACFsc() {
		...
		if( have_rows('platforms' , 'option') ):
			...
			while( have_rows('platforms' , 'option') ) : the_row();
				echo '<li>'; ?>
					...
					<object data="<?php echo get_sub_field('icon'); ?>" type="image/svg+xml" ></object>
	...
	function phone() {
		...
		ob_start(); ?>
			...
			<a class="icon-text-inline" href="tel:<?php echo get_field('phone','option'); ?>">
	...
	function email() {
		...
		ob_start(); ?>
			...
			<a class="icon-text-inline" href="mailto:<?php echo get_field('email_address','option'); ?>">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
